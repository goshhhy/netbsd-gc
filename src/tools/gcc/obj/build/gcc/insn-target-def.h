...
static bool
target_have_load_multiple (void)
{
  return 
#line 8040 "/home/ky0ko/code/netbsd-gc/src/tools/gcc/../../external/gpl3/gcc.old/dist/gcc/config/rs6000/rs6000.md"
...
#define TARGET_HAVE_LOAD_MULTIPLE target_have_load_multiple
...
static rtx_insn *
target_gen_probe_stack_address (rtx x0)
{
  return insnify (gen_probe_stack_address (x0));
}

#undef TARGET_HAVE_PROBE_STACK_ADDRESS
#define TARGET_HAVE_PROBE_STACK_ADDRESS hook_bool_void_true
#undef TARGET_GEN_PROBE_STACK_ADDRESS
#define TARGET_GEN_PROBE_STACK_ADDRESS target_gen_probe_stack_address
#undef TARGET_CODE_FOR_PROBE_STACK_ADDRESS
#define TARGET_CODE_FOR_PROBE_STACK_ADDRESS CODE_FOR_probe_stack_address
...
static rtx_insn *
target_gen_restore_stack_block (rtx x0, rtx x1)
{
  return insnify (gen_restore_stack_block (x0, x1));
}

#undef TARGET_HAVE_RESTORE_STACK_BLOCK
#define TARGET_HAVE_RESTORE_STACK_BLOCK hook_bool_void_true
#undef TARGET_GEN_RESTORE_STACK_BLOCK
#define TARGET_GEN_RESTORE_STACK_BLOCK target_gen_restore_stack_block
#undef TARGET_CODE_FOR_RESTORE_STACK_BLOCK
#define TARGET_CODE_FOR_RESTORE_STACK_BLOCK CODE_FOR_restore_stack_block

static rtx_insn *
target_gen_restore_stack_function (rtx x0, rtx x1)
{
  return insnify (gen_restore_stack_function (x0, x1));
}
...
#define TARGET_GEN_RESTORE_STACK_FUNCTION target_gen_restore_stack_function
...
static rtx_insn *
target_gen_save_stack_function (rtx x0, rtx x1)
{
  return insnify (gen_save_stack_function (x0, x1));
}

#undef TARGET_HAVE_SAVE_STACK_FUNCTION
#define TARGET_HAVE_SAVE_STACK_FUNCTION hook_bool_void_true
#undef TARGET_GEN_SAVE_STACK_FUNCTION
#define TARGET_GEN_SAVE_STACK_FUNCTION target_gen_save_stack_function
#undef TARGET_CODE_FOR_SAVE_STACK_FUNCTION
#define TARGET_CODE_FOR_SAVE_STACK_FUNCTION CODE_FOR_save_stack_function
...
#define TARGET_HAVE_STORE_MULTIPLE target_have_load_multiple
